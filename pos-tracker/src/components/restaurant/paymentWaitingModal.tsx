...
const PaymentWaitingModal: React.FC<PaymentWaitingModalProps> = ({
  ...
  const pollPaymentStatus = async (paymentRef: string) => {
    ...
    try {
      ...
      if (response?.data?.status === "FAILED") {
        ...
        // Close modal after 3 seconds and trigger failure callback
  ...
  // Handle manual close with cleanup
  ...
  const getStatusMessage = () => {
    if (elapsedTime < 15) {
      ...
      return "Payment is taking longer than usual. Please be patient...";
    }
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Timeout in {formatTime(Math.max(0, 180 - elapsedTime))}
              </p>
            </div>
          ...
          <div className="p-8 text-center">
            ...
            <div className="bg-red-50 rounded-lg p-3 mb-6">
              <div className="flex items-start gap-2 text-sm text-red-700">
                ...
                <p>
                  Possible reasons: Insufficient funds, wrong PIN, network
                  timeout, or transaction cancelled by user.
                </p>
              </div>
            </div>
        ...
        {status === "timeout" && (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">
              The payment took too long to complete. The transaction has
              expired.
            </p>
